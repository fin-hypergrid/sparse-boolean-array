 ...
 * 2. If `module` object undefined, we're in browser so define a `window.RangeSelectionModel` object with an `exports` object
 *
 ...
 * 2. If `module` object undefined, then we're in browser so redefine`window.RangeSelectionModel` as its `exports` object
 */
